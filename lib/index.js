...
var _excluded = ["placeholder", "separator", "isLastChild", "ariaLabelOverride", "shouldRender", "inputStyle", "focus", "isDisabled", "hasErrored", "errorStyle", "focusStyle", "disabledStyle", "shouldAutoFocus", "isInputNum", "index", "value", "className", "isInputSecure"];
...
var DELETE = 46;
var SPACEBAR = 32;
var ENTER = 13; // Doesn't really check if it's a style Object
...
var SingleOtpInput = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(SingleOtpInput, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      var inputEl = this.input.current; // Check if focusedInput changed
    ...
    value: function render() {
      var _this$props$numInputs;

      var _this$props3 = this.props,
          placeholder = _this$props3.placeholder,
          separator = _this$props3.separator,
          isLastChild = _this$props3.isLastChild,
          ariaLabelOverride = _this$props3.ariaLabelOverride,
          shouldRender = _this$props3.shouldRender,
          ...
          shouldAutoFocus = _this$props3.shouldAutoFocus,
          isInputNum = _this$props3.isInputNum,
          index = _this$props3.index,
          value = _this$props3.value,
          className = _this$props3.className,
          isInputSecure = _this$props3.isInputSecure,
      ...
      return /*#__PURE__*/_react["default"].createElement("div", {
        ...
        type: this.getType(),
        maxLength: (_this$props$numInputs = this.props.numInputs) !== null && _this$props$numInputs !== void 0 ? _this$props$numInputs : '1',
        ref: this.input,
        disabled: isDisabled,
        value: value ? value : ''
...
var OtpInput = /*#__PURE__*/function (_Component) {
  ...
  function OtpInput() {
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleOnPaste", function (e) {
      ...
      var nextActiveInput = activeInput; // Get pastedData in an array of max size (num of inputs - current position)
      ...
      var pastedData = filteredData.slice(0, numInputs - activeInput).split(''); // Paste data from focused input onwards
    ...
    _defineProperty(_assertThisInitialized(_this2), "handleOnInput", function (e) {
      ...
      if (e.target.value && e.target.value.length > 1) {
        ...
        var otp = _this2.getOtpValue(); // Get pastedData in an array of max size (num of inputs - current position)


        var pastedData = e.target.value.slice(0, numInputs - activeInput).split(''); // Paste data from focused input onwards
    ...
    _defineProperty(_assertThisInitialized(_this2), "renderInputs", function () {
      ...
      var _this2$props3 = _this2.props,
          id = _this2$props3.id,
          autoComplete = _this2$props3.autoComplete,
          ...
          separateAfter = _this2$props3.separateAfter,
          ...
          inputProps = _this2$props3.inputProps;
      var inputs = [];
      ...
      var _loop = function _loop(i) {
        ...
        inputs.push( /*#__PURE__*/_react["default"].createElement(SingleOtpInput, _extends({
  ...
  _createClass(OtpInput, [{
    key: "componentDidUpdate",
    value: //Focus first index on clearing value
